...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(window,               "#ffffff", "#ffffff", "#191919", "#191919")
    ...
    DECLARE_QGC_COLOR(textField,            "#ffffff", "#ffffff", "#000000", "#000000")
    ...
    DECLARE_QGC_COLOR(toolbarBackground,    "#05090a", "#05090a", "#05090a", "#05090a")
    DECLARE_QGC_COLOR(groupBorder,          "#bbbbbb", "#bbbbbb", "#707070", "#707070")

    // Colors not affecting by theming
    //                                              Disabled    Enabled
    DECLARE_QGC_NONTHEMED_COLOR(brandingPurple,     "#05090a", "#05090a")
