...
SetupPage {
    ...
    Component {
        ...
        Flow {
            ...
            Connections {
                target: _ch7Opt
                onValueChanged: calcAutoTuneChannel()
            }
            Connections {
                target: _ch8Opt
                onValueChanged: calcAutoTuneChannel()
                ...
                PIDTuning {
                    ...
                    property var roll: QtObject {
                        ...
                        property var plot: [
                            {
                                name: "Response",
                                value: globals.activeVehicle.rollRate.value
                            },
                            {
                                name: "Setpoint",
                                value: globals.activeVehicle.setpoint.rollRate.value
                            }
                        ]
                    ...
                    property var pitch: QtObject {
                        ...
                        property var plot: [
                            {
                                name: "Response",
                                value: globals.activeVehicle.pitchRate.value
                            },
                            {
                                name: "Setpoint",
                                value: globals.activeVehicle.setpoint.pitchRate.value
                            }
                        ]
                        property var params: ListModel {
                            ListElement {
                    ...
                    property var yaw: QtObject {
                        ...
                        property var plot: [
                            {
                                name: "Response",
                                value: globals.activeVehicle.yawRate.value
                            },
                            {
                                name: "Setpoint",
                                value: globals.activeVehicle.setpoint.yawRate.value
                            }
                        ]
                        property var params: ListModel {
                            ListElement {
